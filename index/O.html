...
<div class="loading-screen">
    <div class="loading-text glitch-text" data-text="Security Alert Sahm in the system ..">
        Security Alert Sahm in the system ..<br>discord.gg/023 لاتنسى تخش الدس
    </div>
</div>
<!-- 
...
<div class="wanted-poster">
    <div class="pin"></div>
    <img src="" alt="Wanted Poster" class="poster-img" />
    <div class="command-linesxb"></div>test</div>
</div> -->
    ...
    <div class="main-content">
        <div class="container">
            ...
            <h1 class="pwned-title">Hacked BY SAHM</h1>
            ...
            <div class="terminal-section">
                <div class="terminal-header">
                    ...
                    <div class="terminal-title">discord.gg/023</div>
                </div>
                ...
                <div class="command-line">
                    <span class="success">
                         SAHM : السلام عليكم ورحمة الله وبركاته<br />
                         لاتنسى تذكر الله وخش الدس رح ننزل لكم كل الطرق عشان تصير هاك (:
                </div>

            </div>

            <div class="footer-message">Officaly Black$Hammer • Sahmnetwork</div>
        ...
        <div class="learn-grid">
            ...
            <div class="learn-footer">
                ...
                <span class="discord-link">discord.gg/023</span>
            </div>
        </div>
    </div>
